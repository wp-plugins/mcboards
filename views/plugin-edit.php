<?php $board = $wpform->getFields(); ?><h2><?php echo "<strong>{$board['board_id']}</strong>"; ?></h2>
<div>
  ...
  <?php } ?>
    ...
    <fieldset>
        ...
        <input type="hidden" id="board_id" name="board_id" value="<?php echo $board['board_id']; ?>" />
        <li>
            <div class="form-label"><label for="width"><?php echo __('Image width', $this->plugin_name) ?></label></div>
            <div class="form-field"><?php echo $board['width']; ?><input type="hidden" id="width" name="width" value="<?php echo $board['width']; ?>" /></div>
